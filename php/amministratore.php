...
if (isset($_SESSION['session_id'])) {
    ...
    //verifica se l'utente è un condomino,nel caso lo rimanda alla sua dashboard
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a id="navAccount" class="nav-link active" href="../php/amministratore.php">Gruppi</a>
                    </li>
                    <li class="nav-item">
                        <a id="navAccount" class="nav-link" href="../account.php">Account</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!--popup che permette all'amministratore di creare un gruppo condominio,i dati dellla form saranno gestiti da create_condominio.php-->
    <div class="overlay" id="overlay">
        <div class="popup">
            <div onclick="CloseModal()" class="CloseIcon"><i class="fa fa-times" aria-hidden="true"></i></div>
            <div class="section-header">
                <h1 class="display-1 section-heading">Crea condominio</h1>
                <div class="underline"></div>
            </div>
            <section class="condominio">
                <div class="form">
                    <form id="form" action="create_condominio.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="name">
                                <h2>Nome</h2>
                            </label>
                            <input type="text" id="name" class="form-control" placeholder="Inserisci nome" name="name" maxlength="20" required>
                        </div>
                        <div class="form-group">
                            <label for="CittaLabel">
                                <h2>Città</h2>
                            </label>
                            <input name="citta" type="text" class="form-control" id="CittaLabel" placeholder="Inserisci città" required>
                        </div>
                        <div class="form-group">
                            <label for="IndirizzoLabel">
                                <h2>Indirizzo</h2>
                            </label>
                            <input type="text" id="IndirizzoLabel" class="form-control" placeholder="Inserisci indirizzo" name="indirizzo" required>
                        </div>
                        <button id="submit" type="submit" class="submit-btn btn btn-info btn-lg" name="create">Crea</button>
                    </form>
                </div>
            </section>
        </div>
    ...
    <!--popup che gestisce l'eliminazione di un gruppo da parte del suo amministratore.Viene mostrato dopo la pressione del bottone delete-->
    <div class="overlay" id="overlay-delete">
        <div class="popup">
            <div onclick="CloseModalD()" class="CloseIcon"><i class="fa fa-times" aria-hidden="true"></i></div>
            <div class="section-header">
                <h1 class="display-1 section-heading">Eliminazione del condominio</h1>
                <div class="underline"></div>
            </div>
            <p class="lead">Sei sicuro di voler eliminare il condominio?</p>
            <div class="clearfix">
                <button type="button" onclick="CloseModalD()" class="cancelbtn btn">Annulla</button>
                <button type="button" id="" onclick="delete_group(this.id);" class="deletebtn btn">Elimina</button>
            </div>
        </div>
    </div>
    ...
    <div class="container" id="groups">
        <div class="section-header">
            ...
            <h1 id="name-link" onclick="javascript:location.href='../account.php'" class="display-1 section-heading"><?php echo $session_user ?></h1>
            <div class="underline"></div>
        </div>
        <script>
            (function() {
                ...
                if (size == 0) {
                    ...
                    for (var i = 0; i + 1 < size; i += 2) {
                        ...
                        //CASO 1: gruppo amministrato - gruppo amministrato
                        if (user == groups[i][3] && user == groups[i + 1][3]) {
                            //2 <div class="col-6"> in cui vengono inserite delle card di bootstrap,nel card-body verranno mostrati il titolo,città,via del condominio e il nome dell'amministratore.Inoltre ci sarà un bottone per entrare nel gruppo e un altro bottone per uscire se si è semplici condomini,invece per eliminare il gruppo se si è l'amministratore di quel condominio.
                            newNode.innerHTML = '<div class="col-6"><div class="card text-center align-middle" data-tilt data-tilt-max="5" data-tilt-speed="100"><div class="card-body"><h5 class="card-title"><b>' + groups[i][0] + '</b></h5><p class="card-text">' + groups[i][1] + ' ,' + groups[i][2] + '.</p><p class="card-text">Di: ' + groups[i][3] + '</p><a id="' + groups[i][0] + " " + groups[i][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalD(\'' + groups[i][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16"><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path></svg></button></div></div></div>' + '<div class="col-6"><div class="card text-center" data-tilt data-tilt-max="5" data-tilt-speed="100"><div class="card-body"><h5 class="card-title"><b>' + groups[i + 1][0] + '</b></h5><p class="card-text">' + groups[i + 1][1] + ' ,' + groups[i + 1][2] + '.</p><p class="card-text">Di: ' + groups[i + 1][3] + '</p><a id="' + groups[i + 1][0] + " " + groups[i + 1][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalD(\'' + groups[i + 1][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16"><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path></svg></button></div></div></div>';
                            //CASO 2: gruppo non amministrato - gruppo amministrato
                        } else if (user != groups[i][3] && user == groups[i + 1][3]) {
                            //2 <div class="col-6"> in cui vengono inserite delle card di bootstrap,nel card-body verranno mostrati il titolo,città,via del condominio e il nome dell'amministratore.Inoltre ci sarà un bottone per entrare nel gruppo e un altro bottone per uscire se si è semplici condomini,invece per eliminare il gruppo se si è l'amministratore di quel condominio.
                            ...
                            //CASO 3: gruppo amministrato - gruppo non amministrato
                        } else if (user == groups[i][3] && user != groups[i + 1][3]) {
                            //2 <div class="col-6"> in cui vengono inserite delle card di bootstrap,nel card-body verranno mostrati il titolo,città,via del condominio e il nome dell'amministratore.Inoltre ci sarà un bottone per entrare nel gruppo e un altro bottone per uscire se si è semplici condomini,invece per eliminare il gruppo se si è l'amministratore di quel condominio.
                            newNode.innerHTML = '<div class="col-6"><div class="card text-center align-middle" data-tilt data-tilt-max="5" data-tilt-speed="100"><div class="card-body"><h5 class="card-title"><b>' + groups[i][0] + '</b></h5><p class="card-text">' + groups[i][1] + ' ,' + groups[i][2] + '.</p><p class="card-text">Di: ' + groups[i][3] + '</p><a id="' + groups[i][0] + " " + groups[i][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalD(\'' + groups[i][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16"><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path></svg></button></div></div></div>' + '<div class="col-6"><div class="card text-center"  data-tilt data-tilt-max="5" data-tilt-speed="100"><div class="card-body"><h5 class="card-title"><b>' + groups[i + 1][0] + '</b></h5><p class="card-text">' + groups[i + 1][1] + ' ,' + groups[i + 1][2] + '.</p><p class="card-text">Di: ' + groups[i + 1][3] + '</p><a id="' + groups[i + 1][0] + " " + groups[i + 1][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalX(\'' + groups[i + 1][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"></path><path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></svg></button></div></div></div>';
                            //CASO 4: gruppo non amministrato - gruppo amministrato
                        } else {
                            //2 <div class="col-6"> in cui vengono inserite delle card di bootstrap,nel card-body verranno mostrati il titolo,città,via del condominio e il nome dell'amministratore.Inoltre ci sarà un bottone per entrare nel gruppo e un altro bottone per uscire se si è semplici condomini,invece per eliminare il gruppo se si è l'amministratore di quel condominio.
                            newNode.innerHTML = '<div class="col-6"><div class="card text-center align-middle" data-tilt data-tilt-max="5" data-tilt-speed="100"><div class="card-body"><h5 class="card-title"><b>' + groups[i][0] + '</b></h5><p class="card-text">' + groups[i][1] + ' ,' + groups[i][2] + '.</p><p class="card-text">Di: ' + groups[i][3] + '</p><a id="' + groups[i][0] + " " + groups[i][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalX(\'' + groups[i][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"></path><path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></svg></button></div></div></div>' + '<div class="col-6"><div class="card text-center" data-tilt data-tilt-max="5" data-tilt-speed="100"><div class="card-body"><h5 class="card-title"><b>' + groups[i + 1][0] + '</b></h5><p class="card-text">' + groups[i + 1][1] + ' ,' + groups[i + 1][2] + '.</p><p class="card-text">Di: ' + groups[i + 1][3] + '</p><a id="' + groups[i + 1][0] + " " + groups[i + 1][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalX(\'' + groups[i + 1][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"></path><path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></svg></button></div></div></div>';
                        }
                    ...
                    for (; i < size; i++) {
                        ...
                        //aggiunta la classe row all'elemento div per creare una riga avente le carattesristiche responsive di bootstrap
                        newNode.className = 'row';
                        //CASO 1: gruppo amministrato
                        if (user == groups[i][3]) {
                            //un <div class="col-6"> in cui viene inserita una card di bootstrap,nel card-body verranno mostrati il titolo,città,via del condominio e il nome dell'amministratore.Inoltre ci sarà un bottone per entrare nel gruppo e un altro bottone per eliminare il gruppo visto che l'user è l'amministratore di quel condominio.
                            ...
                            //CASO 1: gruppo non amministrato
                        } else {
                            //un <div class="col-6"> in cui viene inserita una card di bootstrap,nel card-body verranno mostrati il titolo,città,via del condominio e il nome dell'amministratore.Inoltre ci sarà un bottone per entrare nel gruppo e un altro bottone per uscire visto che l'user è un semplice condomino di quel gruppo.
                            newNode.innerHTML = '<div class="col-6"><div class="card text-center"><div class="card-body"><h5 class="card-title"><b>' + groups[i][0] + '</b></h5><p class="card-text">' + groups[i][1] + ' ,' + groups[i][2] + '.</p><p class="card-text">Di: ' + groups[i][3] + '</p><a id="' + groups[i][0] + " " + groups[i][4] + '" href="#" class="btn btn-primary" onclick="enter_group(this.id)">Entra</a><button type="button" class="btn btn-outline-danger delete-icon" onclick="OpenModalX(\'' + groups[i][0] + '\')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"></path><path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></svg></button></div></div></div>';
                        }
    ...
    <!--bottone dropup,alla pressione verranno mostrate le due scelte:Crea gruppo ed entra in un gruppo-->
    <div class="btn-group dropup">
        <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fa fa-plus"></i>
        </button>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item item-1" href="#" onclick="OpenModal()"><b>Crea gruppo</b></a></li>
            <li><a class="dropdown-item item-2" href="#" onclick="OpenModalE()"><b>Entra in un gruppo</b></a></li>
        </ul>
    </div>
