...
<body>
  ...
  <!-- form in cui inserire username per il quale si vuole richiedere il recpero della password,handler_forgot_password.php controllerà se l'username esiste ed invierà i link all'email associata-->
  <div class="container">
    ...
    <section class="forgot_password">
      <div class="form">
        ...
        <?php endif; ?>
        <h2>Inserire username per cui si vuole recuperare la password,verrà inviato un messaggio all'indirizzo email associato con le istruzioni da seguire.
          <h2 />
      </div>
    </section>
  </div>
